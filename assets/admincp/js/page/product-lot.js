$(function(){
    ...
    function getList() {
        ...
        $.ajax({
            url: "product-lot/get-range" + window.location.search ,
            dataType: 'JSON',
        })
        .done(function(data) {
    ...
    $(`#form_search_product_lot`).submit(function(e){
        e.preventDefault()
        $('#searchButton').click()
    })
    ...
    $(document).on('click', '.btn-edit', function() {
        ...
        $('#inputEditBrand').val(data.brand_id)
        $('#inputEditCategory').val(data.product_category_id)
        $('#inputEditLotName').val(data.lot_name)
    ...
    $('#btnAdd').click(function(e){
        ...
        var data = $('#productLotFormAdd').serializeArray().reduce(function(obj, item) {
            obj[item.name] = item.value;
            return obj;
        }, {});
        data = {
            brand_id: data.inputBrandId,
            lot_name: data.inputLotName,
            price: data.inputPrice,
            product_category_id: data.inputCategoryId
        }
        ...
        .done(function(response) {
            $('#productLotFormAdd').trigger("reset");
        ...
        .fail(function(error) {
            ...
            if (json.brand_id) {
                ...
                $('#inputAddBrandError').text(json.brand_id);
            }
            if (json.lot_name) {
                $('#inputAddLotName').addClass('is-invalid');
                $('#inputAddLotNameError').text(json.lot_name);
            }
            if (json.price) {
                $('#inputAddPrice').addClass('is-invalid');
                $('#inputAddPriceError').text(json.price);
            }
        });
    })
    ...
    $('#btnEdit').click(function(e){
        ...
        data = {
            ...
            product_category_id: data.inputCategory,
            price: data.inputPrice,
        }
        ...
        .fail(function(error) {
            ...
            if (json.lot_name) {
                $('#inputEditLotName').addClass('is-invalid');
                $('#inputEditLotNameError').text(json.lot_name);
            }
            if (json.price) {
